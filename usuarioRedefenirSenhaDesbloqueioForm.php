...
<head>
	<title>Gomes GB - Redefenir Senha Usuario </title>
			...
			<div id="page-inner">
				<div class="row">
					<div class='col-md-10 col-md-offset-1' style='border-bottom: 1px solid black; padding-bottom: 15px;'>
						<div class='col-md-12'>
							<h3 id='titulo'>Desbloqueio Usuario - Redefenir Senha </h3>
						</div>
						...
						<div class='row'>							
							<div class='col-md-8 col-md-offset-2'>
								<input class='btn btn-warning form-control' style='margin-top: 10px;' onclick="mostreAlert()" type='submit' value='Redefenir Senha' />
							</div>
						</div>	
