...
<head>
	<title>Gomes GB - Editar Usuário</title>
			...
			<div id="page-inner">
				<div class="row">
					<div class='col-md-10 col-md-offset-1' style='border-bottom: 1px solid black; padding-bottom: 15px;'>
						<div class='col-md-12'>
							<h3 id='titulo'>Usuário - Editar</h3>
						</div>

						<form action='usuarioEditar.php' method='post'>	
						<?php include "usuarioConsultar.php"; ?>
						<div class='row'> 
							...
							<div class='col-md-5'>
								<input class='form-control input-md' type='text' name='nomeUsuario' value='<?php echo $usuario[0]['nome'] ?>' required>
							</div>
						</div>
						<div class='row'style='margin-top: 10px;' > 
							...
							<div class='col-md-5'>
								<input class='form-control input-md' type='email' name='emailUsuario' value='<?php echo $usuario[0]['email'] ?>' required>
							</div>
						</div>
						<div class='row'>							
