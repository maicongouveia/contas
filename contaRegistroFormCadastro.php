			...
			<div id="page-inner">
				<div class="row">
					<div class='col-md-10 col-md-offset-1' style='border-bottom: 1px solid black; padding-bottom: 15px;'>
						<div class='col-md-12'>
							<h3 id='titulo'>Conta - Registro - Cadastro</h3>
						</div>

						<form action='contaRegistroCadastrar.php' method='post'>	
						...
						<div class='row' style='margin-top: 10px;'> 
							...
							<div class='col-md-5'>
								<input class='form-control input-md' type='text' name='nome' maxlength='25' autofocus="autofocus" required>
							</div>
						</div>
						<div class='row'style='margin-top: 10px;' > 
							<div class='col-md-3 col-md-offset-2'>
						...
						<div class='row'style='margin-top: 10px;' > 
							...
							<div class='col-md-5'>
								<input class='form-control input-md col-md-1' type='decimal' name='valor' required >
							</div>
						</div>
						<div class='row'style='margin-top: 10px;' > 
							<div class='col-md-3 col-md-offset-2'>
							...
							<div class='col-md-5'>
								<input class='form-control input-md col-md-1' type='date' name='dataVencimento' required >
							</div>
						</div>
						<div class='row'style='margin-top: 10px;' > 
							<div class='col-md-3 col-md-offset-2'>
							...
							<div class='col-md-5'>
								<input class='form-control input-md col-md-1' type='date' name='dataPagamento' required >
							</div>
						</div>
						<div class='row'>							
